...
# The file containing users' information that is passed on to the script should have a specific CSV template, which is provided as "template_for_users_to_add_to_active_directory_domain.csv".
If ($args)
{
